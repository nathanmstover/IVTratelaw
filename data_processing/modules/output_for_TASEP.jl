...
"""
function generate_rate_uncertainty(datafileivt::String, new_filename::AbstractString; sigma = 0.27, kwargs...)#set from looking at IE data up until 7/15, variable to change

    sorted_matrix = rate_for_TASEP(datafileivt, sigma; kwargs...) #generate the rates and uncertainties
